...
const Login = () => {
  return (
    <>
      ...
      <div className="w-[70%] min-h-screen mx-auto bg-[#f2fcff]">
        <div className="bg-white min-h-screen shadow-lg p-10 rounded-lg w-full">
          {/* Section Title */}
          ...
          <div className="grid grid-cols-2 gap-4 text-gray-700 my-10 ">
